  ...
  const authContext = useContext(AuthContext);
    ...
    useEffect(() => {
      ...
      const fetchBlog = async () => {
        try {
          const response = await axios.get(`https://final-server-files.vercel.app/api/blogs/${editBlogId}`);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (fields.image === "") {
            ...
            if (editorRef.current) {
                ...
                try {
                  const response = await axios.put(`https://final-server-files.vercel.app/api/blogs/${editBlogId}`, {
                    title: fields.title,
                    image: fields.image,
